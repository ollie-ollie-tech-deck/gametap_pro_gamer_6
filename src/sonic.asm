...
ptr_GM_Sega:	bra.w	GoTo_SplashScreens	; Sega Screen ($00)
...
GM_Title:
	...
	Tit_LoadText:
		...
		move.w	#$794,(v_demolength).w ; run title screen for $794 frames
...
M_Card_GHZ:	dc.b $A	;  GREEN HILL | COLOR LAND
		dc.b $F8, 5, 0, 8, $80		; C
		dc.b $F8, 5, 0, $32, $90	; O
		dc.b $F8, 5, 0, $26, $A0	; L
		dc.b $F8, 5, 0, $32, $B0	; O
...
M_Card_LZ:	dc.b 9			; LABYRINTH
		...
		dc.b $F8, 5, 0,	$1C, $34
		even
M_Card_MZ:	dc.b 8	;  MARBLE | FUCK YOU
		dc.b $F8, 5, 0, $14, $80	; F
		dc.b $F8, 5, 0, $46, $90	; U
		dc.b $F8, 5, 0, 8, $A0		; C
		dc.b $F8, 5, 0, $22, $B0	; K
...
M_Got_SonicHas:	dc.b $D	;  SONIC HAS | GO TO GAMETAP
		dc.b $F8, 5, 0, $18, $9C	; G
		dc.b $F8, 5, 0, $32, $AC	; O
		...
		dc.b $F8, 5, 0, 0, $4C		; A
		dc.b $F8, 5, 0, $36, $5C	; P
M_Got_Passed:	dc.b 7	;  PASSED | DOT COM
		dc.b $F8, 5, 0, $0C, $CC	; D
		dc.b $F8, 5, 0, $32, $DC	; O
		dc.b $F8, 5, 0, $42, $EC	; T
